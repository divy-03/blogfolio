...
const DATA = {
  ...
  contact: {
    social: {
      ...
      Codeforces: {
        name: "Codeforces",
        url: "https://codeforces.com/profile/excl",
        icon: Icons.codeforces,
      },
      Email: {
        name: "Send Email",
        url: "mailto:pathakdivy03@gmail.com",
        icon: Icons.email,
      },
    },
  },
...
export function DockMenu() {
  ...
  return (
    <div className="z-50 fixed bottom-8 left-1/2 -translate-x-1/2 flex flex-row items-center justify-center">
      <TooltipProvider>
